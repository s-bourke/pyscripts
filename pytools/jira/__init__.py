...
__headers = [
	...
	ColumnDefinition("Summary", width=95),
	ColumnDefinition("Status", width=15),
	ColumnDefinition("Assignee", width=20, cell_style="conditional", cell_style_context={"Samuel Bourke": "orange3"}),
...
def __issues_to_table_row(issues):
	...
	for issue in issues:
		converted_issues.append(
			[issue.key, issue.fields.summary, issue.fields.status, issue.fields.assignee, issue.fields.created[:10], f"https://costcutter.jira.com/browse/{issue.key}"])
